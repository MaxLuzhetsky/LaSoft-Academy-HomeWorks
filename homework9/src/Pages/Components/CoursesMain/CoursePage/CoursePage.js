...
export default function CoursePage() {
    ...
    const { courseName, courseImg, courseLvl, courseDur,courseDecr ,coursePrice } = state;
    ...
    return (
        ...
        <>
            <div className="header_container">
                ...
                <button className='nav_menu_bttn back-button' onClick={() => navigate(-1)}>  Back</button>
            ...
            <div className='course-page-container'>
                <div className='course-page-left'>
                    ...
                    <button onClick={()=>navigate('/apply' , { state:{courseName: courseName}})  } className='course-page-apply'>Apply Now</button>
                </div>
